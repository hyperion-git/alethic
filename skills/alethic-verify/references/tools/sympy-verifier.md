...
- **Special function identities**: Verify with SymPy's special function module
- **Dimensional consistency** (physics): Use `sympy.physics.units` to verify all terms have matching dimensions
