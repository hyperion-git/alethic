...
| Mean confidence | 0.6541 | 0.7575 |
| Mean iterations | 7.88 | 7.81 |
| Mean cost (tokens) | 1883773 | 1880147 |
...
- E solves, F doesn't: 13
- F solves, E doesn't: 102
- Discordant pairs: 115
- Chi-squared: 67.3391
- p-value: 0.000000
...
| insight | 0.0221 | 0.0435 | 2484 | F |
| adversarial | 0.0142 | 0.0385 | 493 | F |

## Diagnostics (from traced trials)

| Metric | Model E | Model F |
|--------|---------|---------|
| approach_discovery_rate | 1.3240 | 2.5725 |
| wasted_iterations | 0.9975 | 0.9953 |
| cost_per_solve | 411341.6402 | 583443.7435 |
| candidate_diversity | 1.3240 | 2.5725 |
| false_acceptance | 0.0000 | 0.0000 |
| stall_recovery_success | 0.0163 | N/A |
