...
- [ ] **Step 1.3: Move `SearchConfig` into `models.py`**
...
- [ ] **Step 1.4: Add the two `AgentConfig` fields and validation**
...
- [ ] **Step 1.5: Re-export from `search.py` and `__init__.py`**
...
- [ ] **Step 1.6: Run tests to verify they pass, plus regression**
...
- [ ] **Step 2.1: Write the failing tests** (append to `tests/test_proof_graph.py`, reusing its existing import style)
...
- [ ] **Step 3.3: Implement** (append to `src/alethic/session.py`, after `load_checkpoint`)
...
- [ ] **Step 4.1: Write the failing tests** (append to `tests/test_search.py`; use the file's existing mock helpers if equivalent ones exist — these are self-contained otherwise)
...
- [ ] **Step 4.4: Run tests to verify they pass, plus full search regression**
...
- [ ] **Step 5.4: Run tests to verify they pass, plus regressions**
...
- [ ] **Step 6.4: Run tests to verify they pass, plus agent regression**
...
- [ ] **Step 7.4: Run tests to verify they pass, plus CLI regression**
...
- [ ] **Step 8.4: Run tests to verify they pass, plus harness regression**
...
- [ ] **Step 9.1: Full test suite, lint, type check**
